...
#define CMS_BEGIN(module_name)                                          \
  ...
  void on_terminate();                                                     \
  void on_reload();                                                        \
  static inline CMSEXT_BIND_CLASS_##module_name module_name(&on_load,      \
                                                            &on_init,      \
                                                            &on_terminate, \
                                                            &on_reload);
#define CMS_END() }
